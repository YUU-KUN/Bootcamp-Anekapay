...
router.get('/checkout', (req, res) => {
    ...
    keranjang.tanggal = Date.now().toString()
    keranjang.save()
...
router.get('/riwayat', (req, res) => {
    Keranjang.find( (err, docs) => {
        ...
        if (!err) {
            ...
            res.send('Gagal menampilkan data keranjang')
            console.log(err);
        }
    }).lean()
})

router.get('/detailRiwayat', (req, res) => {
    DetailKeranjang.find( (err, docs) => {
        console.log(docs)
        if (!err) {
            res.render('user/detailRiwayat', {
                viewTitle: "Riwayat",
                detailKeranjang: docs 
            })
        } else {
            res.send('Gagal menampilkan data keranjang')
            console.log(err);
